...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  const { user, switchRole, logout, notifications, markNotificationRead, performSearch, clearNotifications, addNotification } = useUser();
  ...
  const navItems: NavItem[] = [
    {
      ...
      icon: Home,
      href: `/${user.role}`,
      role: ['super-admin', 'sub-admin', 'secretary'],
    },
    {
      label: 'العيادات',
      icon: Building,
      href: `/${user.role}/clinics`,
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <aside className={`hidden md:flex md:flex-col md:w-64 md:fixed md:inset-y-0 z-50 bg-white border-l`}>
      ...
      <div className="flex flex-col md:mr-64 flex-1 min-h-0">
        <header className="bg-white border-b sticky top-0 z-20">
          <div className="flex items-center justify-between h-16 px-6">
            <div className="flex items-center">
              <Button variant="ghost" size="icon" onClick={handleSidebarToggle} className="md:hidden">
            ...
            <div className="flex items-center gap-2">
                              ...
                              {searchResults
                                ...
                                .map(result => (
                                  ...
                                  >
                                    ...
                                    <span>{result.name} - {result.doctorName}</span>
                                  </CommandItem>
                                ))}
                            </CommandGroup>
                          )}
                              ...
                              {searchResults
                                ...
                                .map(result => (
                                  ...
                                  >
                                    ...
                                    <span>{result.patientName} - {result.clinicName}</span>
                                  </CommandItem>
                                ))}
                            </CommandGroup>
                          )}
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onClick={() => switchRole('super-admin')}>
                    <User className="ml-2 h-4 w-4" />
                    <span>مدير عام</span>
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => switchRole('sub-admin')}>
                    <User className="ml-2 h-4 w-4" />
                    <span>مدير فرعي</span>
                  </DropdownMenuItem>
