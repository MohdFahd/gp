...
const LoginPage = () => {
  const { user, setUser, isAuthenticated, requestedRole, setRequestedRole } = useUser();
  ...
  const roleSwitchingMessage = requestedRole && (
    <div className="bg-yellow-50 border border-yellow-200 p-3 rounded mt-4 mb-4">
      <p className="text-sm text-yellow-800">
        يرجى إدخال بيانات الدخول للحساب {requestedRole === 'super-admin' ? 'المدير العام' : requestedRole === 'sub-admin' ? 'المدير الفرعي' : 'السكرتير'}
      </p>
    </div>
  );
  ...
  const demoInstructions = (
    <div className="bg-blue-50 border border-blue-200 p-3 rounded mt-4">
      <p className="text-sm text-blue-800 mb-1">للتجربة، استخدم أحد الحسابات التالية:</p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-gray-900">تسجيل الدخول</h2>
        </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-xs text-clinic-primary hover:underline">
                    نسيت كلمة المرور؟
                  </Link>
                </div>
                <Input 
              ...
              <div className="text-center mt-4">
                ...
                <Link to="/register" className="text-sm text-clinic-primary hover:underline">
                  تسجيل جديد
                </Link>
              </div>
            </form>
