...
const SettingsPage = () => {
  ...
  // System settings state (for super-admin)
  ...
  const handleSystemReset = () => {
    if (window.confirm('هل أنت متأكد من رغبتك في إعادة تعيين النظام؟ سيتم حذف كل البيانات.')) {
      setLoading(true);
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">إشعارات للمواعيد الجديدة والمعدلة والملغاة</div>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">إشعارات عند إرسال طلب عيادة جديدة</div>
                    </div>
                    <Switch 
                      checked={notificationSettings.clinicRequests}
                      onCheckedChange={(checked) => 
                        setNotificationSettings(prev => ({ ...prev, clinicRequests: checked }))
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">إشعارات للمعاملات المالية والمدفوعات</div>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-medium">إشعارات الرسائل النصية (SMS)</div>
                      <div className="text-sm text-gray-500">استلام الإشعارات عبر الرسائل النصية</div>
                    </div>
                    <Switch 
          ...
          <TabsContent value="security" className="space-y-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="current-password" className="text-sm font-medium">كلمة المرور الحالية</label>
                    <Input 
                      id="current-password" 
                      type="password" 
                  ...
                  <div className="space-y-2">
                    <label htmlFor="confirm-password" className="text-sm font-medium">تأكيد كلمة المرور الجديدة</label>
                    <Input 
                      id="confirm-password" 
                      type="password"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">تفعيل التحقق من خطوتين لتأمين حسابك بشكل أفضل</div>
                    </div>
                    <Switch />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-medium">جلسات تسجيل الدخول النشطة</div>
                      <div className="text-sm text-gray-500">عرض وإدارة جلسات تسجيل الدخول النشطة</div>
                    </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <label htmlFor="system-name" className="text-sm font-medium">اسم النظام</label>
                      <Input 
                        id="system-name" 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="system-logo" className="text-sm font-medium">شعار النظام</label>
                      <div className="flex items-center space-x-4 space-x-reverse">
                        <Input 
                          id="system-logo" 
                          type="file"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="default-lang" className="text-sm font-medium">اللغة الافتراضية</label>
                      <Select 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="system-email" className="text-sm font-medium">البريد الإلكتروني للنظام</label>
                      <Input 
                        id="system-email" 
                        type="email" 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="sms-api-key" className="text-sm font-medium">مفتاح واجهة برمجة التطبيقات لخدمة الرسائل النصية</label>
                      <Input 
                        id="sms-api-key" 
                        type="password"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="system-desc" className="text-sm font-medium">وصف النظام</label>
                      <Textarea 
                        id="system-desc" 
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">تفعيل وضع الصيانة وإيقاف الوصول العام للنظام</div>
                      </div>
                      <Switch 
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="font-medium text-red-600">إعادة تعيين النظام</div>
                        <div className="text-sm text-red-500">إعادة تعيين النظام كاملاً وحذف جميع البيانات. هذا الإجراء لا يمكن التراجع عنه.</div>
                      </div>
                      <Button 
                        variant="outline" 
